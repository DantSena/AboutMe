...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function typeWriter() {
        ...
        if (isDeleting) {
            heroSubtitle.innerHTML = "Saya " + currentProfession.substring(0, charIndex - 1) + '<span class="cursor">|</span>';
            charIndex--;
            typingSpeed = 75;
        } else {
            heroSubtitle.innerHTML = "Saya " + currentProfession.substring(0, charIndex + 1) + '<span class="cursor">|</span>';
    ...
    function smoothScroll(event) {
        ...
        // Hanya cegah default kalau target adalah anchor dalam halaman (#)
        if (targetId && targetId.startsWith('#')) {
            ...
            if (targetElement) {
                ...
                // Tutup menu mobile kalau sedang aktif
            ...
            // Jika bukan anchor (#), biarkan browser buka link seperti biasa
            return;
        }
    }    
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            showNotification('Saya sarankan hubungi langsung Whatsapp', 'Ok');
